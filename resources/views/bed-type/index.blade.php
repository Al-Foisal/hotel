...
<div class="row">
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-md-6">
                <form action="{{route('rrs.bedType.index')}}" class="me-1">
                    <div class="input-group mb-3 table-search-box">
                        ...
                        <a class="btn btn-danger" href="{{route('rrs.bedType.index')}}" title="Reset">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('rrs.bedType.update',$item->id)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label class="form-label" for="exampleInputEmail1">Bed Type</label>
                                                            <input type="text" class="form-control" placeholder="Enter bed type" name="name" required value="{{$item->name??''}}">
                                                        </div>
...
<div class="modal fade modal-fullscreen-down" id="createNewModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('rrs.bedType.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="exampleInputEmail1">Bed Type*</label>
                            <input type="text" class="form-control" placeholder="Enter bed type" name="name" required>
                        </div>
