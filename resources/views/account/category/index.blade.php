...
@section('title','Account category setup')
@section('content')
<!-- Page-Title -->
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title text-capitalize fw-semibold">Account category setup</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{route('dashboard')}}">{{config('app.name')}}</a>
                        </li>
                        <li class="breadcrumb-item">Account</li>
                        <li class="breadcrumb-item active">Account Category</li>
                    </ol>
                </div><!--end col-->
            </div><!--end row-->
...
<div class="row">
    ...
    <div class="card">
        <div class="card-header row">
            ...
            <div class="col-md-6">
                <form action="{{route('account.category.index')}}" class="me-1">
                    <div class="input-group mb-3 table-search-box">
                        ...
                        <a class="btn btn-danger" href="{{route('account.category.index')}}" title="Reset">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-start">
                                    ...
                                    <form action="{{route('account.category.delete',$item->id)}}" method="post">
                                        @csrf
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('account.category.update',$item->id)}}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label" for="exampleInputEmail1">Account category name*</label>
                                                            <input type="text" class="form-control" placeholder="Enter account category name" name="name" required value="{{$item->name??''}}">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
            ...
            <div class="modal-body">
                <form action="{{route('account.category.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="exampleInputEmail1">Account category name*</label>
                            <input type="text" class="form-control" placeholder="Enter account category name" name="name" required >
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="exampleInputEmail1">Type*</label>
                            <select name="type" class="form-control">
