...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('account.voucher.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="account_category_id" class="form-control" required>
                            ...
                            @else
                            <option value="{{$category->id}}" style="color:greeen;">{{$category->name}}</option>
                            @endif
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Enter voucher number" name="voucher_number" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="exampleInputEmail1">Voucher date*</label>
                        <input type="date" class="form-control" placeholder="Enter voucher date" name="voucher_date" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="exampleInputEmail1">Amount*</label>
                        <input type="number" step="0.01" class="form-control" placeholder="Enter amount" name="amount" required>
                    </div>
                    <div class="col-md-6 mb-3">
